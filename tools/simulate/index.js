...
const Dex = require('../../...sim-dist-dist-dist/dex').Dex;
global.Config = {allowrequestingties: false};
Dex.includeModData();

const {ExhaustiveRunner} = require('../../...sim-dist-dist-dist/tools/exhaustive-runner');
const {MultiRandomRunner} = require('../../...sim-dist-dist-dist/tools/multi-random-runner');
